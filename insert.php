...
$fname=$_POST['fname'];
	...
	$date=date("Y-m-d");
$sql="insert into job_cv(first_name,last_name,father_name,mother_name,dob,blood,	religion,gender,marrid,national_id,email,contact,	address,s_institute,s_group,s_pass,s_result,s_board,h_institute,h_group,h_pass,h_result,h_board,date) 
values(
